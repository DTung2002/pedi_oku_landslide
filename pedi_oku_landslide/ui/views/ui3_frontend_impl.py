...
from pedi_oku_landslide.pipeline.runners.ui3_backend import UI3BackendService, extract_curvature_rdp_nodes
from .ui3_preview_scene import AnchorMarkerItem, ZoomableGraphicsView
...
def _prune_vector_zero_boundaries(
    ...
    *,
    ...
    # Keep only the first vector=0 boundary seen from slip start.
...
class CurveAnalyzeTab(QWidget):
    ...
    def set_context(self, project: str, run_label: str, run_dir: str) -> None:
        ...
        ap = backend_inputs.get("auto_paths", {}) or auto_paths()
        ...
        self.dem_path_smooth = _pick_first(
            ...
            backend_inputs.get("dem_path_smooth", ""),
            ap.get("dem", ""),
        ...
        self.slip_path = js.get("slip_path") or backend_inputs.get("slip_path", "") or ap.get("slip", "")
    ...
    def _populate_group_table_for_current_line(self) -> None:
        ...
        try:
            ...
            if os.path.exists(path):
                try:
                    _data, groups = self._load_group_json_data(
                        path,
                        line_id=self._line_id_current(),
                        apply_settings=True,
                    )
